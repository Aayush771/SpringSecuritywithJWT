package com.masai.springjwt.Service;
...
public class ProductService {
    ...
    public String addUser(UserInfo userInfo) {
        UserInfo user1 = repository.findByEmail(userInfo.getEmail());
        if(user1==null){
            userInfo.setPassword(passwordEncoder.encode(userInfo.getPassword()));
            UserInfo savedUser = repository.save(userInfo);
            return "User is saved Successfully";
        }else return "User is already exist with this email "+userInfo.getEmail();
